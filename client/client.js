...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // --- 静态形态的样式注入(替代动态 runner 的 styles.insert) ---
    function insertCss(css) {
      const el = document.createElement('style')
      el.setAttribute('data-plugin', 'sent-msg-locator')
      el.textContent = css
